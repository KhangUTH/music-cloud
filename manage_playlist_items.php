...
<div id="list_clone" class="d-none">
	...
	<div id="pdet" class="d-flex justify-content-between align-items-center">
		<div class="d-flex">
<img src="assets/uploads/play.jpg" alt="" class="img-thumbnail bg-gradient-1" style="width: 50px;height: 50px;object-fit: cover" onerror="this.onerror=null;this.src='assets/default_cover.png';">
			<div class="ml-2 mr-4">
