...
<img src="assets/uploads/<?php echo isset($cover_photo) ? $cover_photo : '' ?>" alt="" id="cover" class="img-fluid img-thumbnail" onerror="this.onerror=null;this.src='assets/default_cover.png';">
			</div>
		</div>
	</form>
</div>
